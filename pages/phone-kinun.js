            ...
            <div className="max-w-[1240px] w-full h-full mx-auto grid place-items-center px-4 py-16">
                <div>
                    ...
                    <Carousel>
                        ...
                        <div>
                            <img src="/assets/projects/phone-kinun/4.png" />
                        </div>
                        <div>
                            <img src="/assets/projects/phone-kinun/5.png" />
                        </div>
                        <div>
                            <img src="/assets/projects/phone-kinun/6.png" />
                        </div>
                    </Carousel>
                    <div className='grid md:grid-cols-5'>
                        <div className='col-span-4'>
                            ...
                            <p className='flex items-center gap-1 my-2'> <GoPrimitiveDot />This is a full-stack CRUD operation based web application created using NodeJS, NodeJS, ExpressJs, and MongoDB. </p>
                            <p className='flex items-center gap-1 my-2'> <GoPrimitiveDot />This is a full-stack CRUD operation based web application created using ExpressJS, NodeJS, ExpressJs, and MongoDB.</p>
                            <p className='flex items-center gap-1 my-2'> <GoPrimitiveDot />This is a full-stack CRUD operation based web application created using MongoDB, NodeJS, ExpressJs, and MongoDB.</p>
                            <p className='flex items-center gap-1 my-2'> <GoPrimitiveDot />This is a full-stack CRUD operation based web application created using MongoDB, NodeJS, ExpressJs, and MongoDB.</p>
                            <p className='flex items-center gap-1 my-2'> <GoPrimitiveDot />Regular users can book any product or can add any to product to their wishlist. From the my order or wishlist they can complete the payment process for a specific product</p>
                            <p className='flex items-center gap-1 my-2'> <GoPrimitiveDot />Payment functionality is implemented using stripe payment gateway.</p>
                            ...
                            <p className='flex items-center gap-1 my-2'> <GoPrimitiveDot />User specific private routes has been used to protect the admin routes, seller routes and buyer routes.</p>
